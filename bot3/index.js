...
const config = {
    ...
    Número do criador: 'https://api.whatsapp.com/send?phone=5547992091566&text=Roi',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g',
    whatsapp: 'https://chat.whatsapp.com/HHUtT8Qcg7W9AxoJCgaR8m',
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[❗] gif mt grande slc mlk doente *!stickerGif* max 10 sec!', id)
                )
            }
            break     
     case 'sticker':
